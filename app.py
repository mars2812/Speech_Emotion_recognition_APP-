...
and reliable emotion detection.
    ...
    if nav_choice == "About us":
        ...
        team_members = [
            {"name": "Matrika Dhamala","usn":"1HK21CS074", "email":"1hk21cs074@hkbk.edu.in","role":"Project Lead", "photo": "team/matu.jpg"},
            {"name": "Mohamed Rayyan Ahmed","usn":"1HK21CS082", "email":"1hk21cs082@hkbk.edu.in", "photo": "team/rayyan.jpg"},
            {"name": "Mohammed Ayan","usn":"1HK21CS089", "email":"1hk21cs089@hkbk.edu.in", "photo": "team/ayan.jpg"},
            {"name": "Mohammed Irfan Sufiyan","usn":"1HK21CS093", "email":"1hk21cs093@hkbk.edu.in", "photo": "team/irfan.jpg"}
        ]
        ...
        col1, col2 = st.columns([1, 3])
        with col1:
            st.image("team/maam.jpg", width=100)
        with col2:
            st.markdown(f"**Assistant Professor**")
            st.markdown(f"**Najmusher (NH)**")
            st.markdown(f"*Email: najmusher@hkbk.edu.in*")
            st.markdown("Thank you ma'am for your immense support throughout this project.")
